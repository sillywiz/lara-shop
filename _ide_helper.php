 ...
 * Generated for Laravel 4.2.12 on 2014-12-17.
 *
...
namespace {
    ...
    class Menu extends \Pingpong\Menus\Facades\Menu{
        ...
        public static function make($name){
            return \Pingpong\Menus\Menu::make($name);
        }
        ...
        public static function destroy(){
            \Pingpong\Menus\Menu::destroy();
        }
        
    }


    class Role extends \Pingpong\Trusty\Entities\Role{
        
    }


    class Permission extends \Pingpong\Trusty\Entities\Permission{
        
    }


    class Trusty extends \Pingpong\Trusty\Facades\Trusty{
         ...
         * @static 
         */
        public static function when($request, $permission){
            return \Pingpong\Trusty\Trusty::when($request, $permission);
        }
         ...
         * @static 
         */
        public static function registerPermissions($permissions = null){
            \Pingpong\Trusty\Trusty::registerPermissions($permissions);
        }
        ...
        public static function forbidden(){
            return \Pingpong\Trusty\Trusty::forbidden();
        }
